...
public class TertiaryMongoAutoConfiguration {
    ...
    public static final String MONGO_PROPERTIES_CUSTOMIZER = "tertiaryMongoPropertiesCustomizer";    // $NON-NLS-1$
    public static final String MONGO_CLIENT_FACTORY = "tertiaryMongoClientFactory";    // $NON-NLS-1$
    public static final String MONGO_CLIENT_SETTINGS = "tertiaryMongoClientSettings";    // $NON-NLS-1$
    public static final String MONGO_CLIENT = "tertiaryMongoClient";    // $NON-NLS-1$
    public static final String MONGO_DATABASE_FACTORY = "tertiaryMongoDatabaseFactory";    // $NON-NLS-1$
    ...
    public static final String MONGO_CUSTOM_CONVERSIONS = "tertiaryMongoCustomConversions";    // $NON-NLS-1$
    public static final String MONGO_MAPPING_CONTEXT = "tertiaryMongoMappingContext";    // $NON-NLS-1$
    public static final String MONGO_MAPPING_CONVERTER = "tertiaryMongoMappingConverter";    // $NON-NLS-1$
